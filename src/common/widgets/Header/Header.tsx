       ...
       <div className='flex items-center justify-center md:justify-between' >
          ...
          <Link href='/' className='flex' >
             <AnimatedTextCharacter 
                text='1'
                className='text-4xl font-bold text-sky-700' 
             />
             <AnimatedTextCharacter 
                text='nhale.'
                className='text-4xl text-white-700/80' 
             />
          </Link>
          ...
          <motion.ul variants={container} initial="hidden" animate="visible" className='__navright' > 
            ...
            <Button href="https://demo2.1nhale.in/public_assets/Gurinder-Singh-Resume.pdf" primary > Resume  </Button>
          </motion.ul>
